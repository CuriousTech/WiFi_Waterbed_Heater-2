const char index_page[] PROGMEM =
   ...
   "  cf=d.c\n"
   "  a.temp.innerHTML=d.waterTemp+'&deg'+cf\n"
   "  a.on.innerHTML=(d.on?\"<font color='red'><b>\":\"\")+\"> \"+d.hiTemp+\"&deg\"+cf+(d.on?\"</b></font>\":\"\")\n"
   ...
   "openSocket()\n"
   "}\">\n"
   "<h3 align=\"center\">WiFi Waterbed Heater 2</h3>\n"
   "<table align=right>\n"
   "<tr><td align=center><div id=\"time\"></div></td><td align=center><div id=\"temp\"></div> </td><td align=center><div id=\"on\"></div></td></tr>\n"
   "<tr><td align=center>Bedroom: </td><td align=center><div id=\"rt\"></div></td><td align=center><div id=\"rh\"></div> </td></tr>\n"
   "<tr><td colspan=2>TZ <input id='tz' type=text size=2 value='-5' onchange=\"{setTZ()}\"> &nbsp &nbsp </td>\n"
   ...
   "</div>\n"
   "</td></tr>\n"
   "<tr><td> $<input id='K' type=text size=2 value='0.1457' onchange=\"{setPPK()}\"> </td><td></td><td><input id=\"myKey\" name=\"key\" type=text size=40 placeholder=\"password\" style=\"width: 100px\" onChange=\"{localStorage.setItem('key', key = document.all.myKey.value)}\"></td></tr>\n"
   "</table>\n"
   "</body>\n"
   "</html>\n";
